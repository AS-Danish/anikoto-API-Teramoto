  ...
  paths: {
                        ...
                        sources: {
                          ...
                          items: {
                            ...
                            properties: {
                              ...
                              proxyUrl: { type: "string", nullable: true, description: "Time-limited signed proxy URL" },
                              tracks: {
                                type: "array",
                                items: {
                                  type: "object",
                                  properties: {
                                    ...
                                    proxyUrl: { type: "string", description: "Time-limited signed proxy URL" },
                                  },
                                },
                              },
                            },
    ...
    "/proxy": {
      get: {
        ...
        description:
          "Internal signed fallback proxy. URLs are generated by /watch, expire, and are restricted to approved streaming hosts.",
        ...
        parameters: [
          ...
          { name: "v", in: "query", required: true, schema: { type: "string", enum: ["1"] } },
        ...
        responses: {
          ...
          "403": { description: "Streaming destination is not approved" },
          "502": { description: "Approved upstream could not be reached" },
        },
      },
    },
  },
